<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminbookinventory.aspx.cs" Inherits="LibraryManagement1.adminbookinventory" %>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                           &nbsp;<img id="imgview" Height="150px" src="book_inventory/books1.png" /></center>
                     </div>
                  </div>
                  <div class="row">
                     <div class="col">
               ...
               <div class="card-body">
                  ...
                  <div class="row">
                     <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:elibraryDBConnectionString %>" 
                         SelectCommand="SELECT [book_id], [book_name], [genre], [author_name], [publisher_name], [publish_date], [edition], [book_cost], [current_stock], [actual_stock], [book_description], [no_of_pages] FROM [book_master_tb1]"></asp:SqlDataSource>
                     <div class="col">
